                        ...
                        <form method="POST"  enctype="multipart/form-data" >
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <label class="profile-view inputlabl" style="font-weight: normal"><?php echo (!empty($data['traveler_profiledata']))?$data['traveler_profiledata']->food_allergies:'';?></label>
                                        <div class="profile-edit">
                                            <input type="text" name="food_allergies" id="food_allergies" class="form-control" value="<?php echo (!empty($data['traveler_profiledata']))?$data['traveler_profiledata']->food_allergies:'';?>"> 
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <label class="profile-view inputlabl" style="font-weight: normal"><?php echo (!empty($data['traveler_profiledata']))?$data['traveler_profiledata']->shirt_size:'';?></label>
                                        <div class="profile-edit">
                                            <input type="text" name="shirt_size" id="shirt_size" class="form-control" value="<?php echo (!empty($data['traveler_profiledata']))?$data['traveler_profiledata']->shirt_size:'';?>">            </div>
                                    </div>
                                </div>       
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <label class="profile-view inputlabl" style="font-weight: normal"><?php if(!empty($data['traveler_profiledata'])){ if($data['traveler_profiledata']->is_mental_conditions==1){ echo 'yes'; }else{ echo  'No' ; } } ?></label>
                                        <div class="profile-edit">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <label class="profile-view inputlabl" style="font-weight: normal"><?php echo(!empty($data['traveler_profiledata']))?$data['traveler_profiledata']->emergency_contact_name:'';?></label>
                                        <div class="profile-edit">
                                            <input type="text" name="emergency_contact_name" id="emergency_contact_name" class="form-control" value="<?php echo (!empty($data['traveler_profiledata']))?$data['traveler_profiledata']->emergency_contact_name:'';?>">                </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label custom-lbl">Phone</label>	
                                    <div class="col-sm-9">
                                        <label class="profile-view inputlabl" style="font-weight: normal"><?php echo (!empty($data['traveler_profiledata']))?$data['traveler_profiledata']->emergency_contact_phone:'';?></label>
                                        <div class="profile-edit">
                                            <input type="text" name="emergency_contact_phone" id="emergency_contact_phone" class="form-control" value="<?php echo (!empty($data['traveler_profiledata']))?$data['traveler_profiledata']->emergency_contact_phone:'';?>">                </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <label class="profile-view inputlabl" style="font-weight: normal"><?php echo (!empty($data['traveler_profiledata']))?$data['traveler_profiledata']->personality_previous_travel:'';?></label>
                                        <div class="profile-edit">
                                            <input type="text" name="personality_previous_travel" id="personality_previous_travel" class="form-control" value="<?php echo (!empty($data['traveler_profiledata']))?$data['traveler_profiledata']->personality_previous_travel:'';?>">                </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label custom-lbl">Where are your originally from?</label>
                                    <div class="col-sm-9">
                                        <label class="profile-view inputlabl" style="font-weight: normal"><?php echo (!empty($data['traveler_profiledata']))?$data['traveler_profiledata']->personality_originally_from:'';?></label>
                                        <div class="profile-edit">
                                            <input type="text" name="personality_originally_from" id="personality_originally_from" class="form-control" value="<?php echo (!empty($data['traveler_profiledata']))?$data['traveler_profiledata']->personality_originally_from:'';?>">                </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label custom-lbl">Where did you go to school?</label>
                                    <div class="col-sm-9">
                                        <label class="profile-view inputlabl" style="font-weight: normal"><?php echo (!empty($data['traveler_profiledata']))?$data['traveler_profiledata']->personality_school:'';?></label>
                                        <div class="profile-edit">
                                            <input type="text" name="personality_school"  id="personality_school" class="form-control" value="<?php echo (!empty($data['traveler_profiledata']))?$data['traveler_profiledata']->personality_school:'';?>">                </div>
                                    </div>
                                </div>
                                <div class="form-group no-border">
                                    <label class="col-sm-3 control-label custom-lbl">Is there anything else we should know about you?</label>
                                    <div class="col-sm-9">
                                        <label class="profile-view inputlabl" style="font-weight: normal"><?php echo (!empty($data['traveler_profiledata']))?$data['traveler_profiledata']->personality_about:'';?></label>
                                        <div class="profile-edit">
                                            <input type="text" name="personality_about" id="personality_about" class="form-control" value="<?php echo (!empty($data['traveler_profiledata']))?$data['traveler_profiledata']->personality_about:'';?>">                </div>
                                    </div>
                                </div>
								<input type="hidden" name="_token" value="{{ csrf_token() }}">
