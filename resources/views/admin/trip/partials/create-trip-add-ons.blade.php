		...
		<div class="panel panel-success add_on_details">
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-md-4">
						<div class="form-group">
							{!! Form::label('addon[0][addons_name]', 'Add ons Name') !!}
							{!! Form::text('addon[0][addons_name]', null, ['class' => 'form-control']) !!}
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							{!! Form::label('addon[0][addons_detail]', 'Add ons Detail') !!}
							{!! Form::text('addon[0][addons_detail]', null, ['class' => 'form-control']) !!}
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							{!! Form::label('addon[0][addons_cost]', 'Add ons Cost') !!}
							{!! Form::number('addon[0][addons_cost]', null, ['class' => 'form-control']) !!}
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							{!! Form::label('addon[0][addons_our_cost]', 'Add ons Our Cost') !!}
							{!! Form::number('addon[0][addons_our_cost]', null, ['class' => 'form-control']) !!}
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							{!! Form::label('addon[0][addons_due_date]', 'Due Date') !!}
							{!! Form::date('addon[0][addons_due_date]', null, ['class' => 'form-control']) !!}
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							{!! Form::label('addon[0][addons_reserve_type]', 'Reserve Type') !!}
							{!! Form::select('addon[0][addons_reserve_type]', array(0 => 'Flat', 1 => 'Percentage'), null, ['class' => 'form-control']) !!}
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							{!! Form::label('addon[0][addons_reserve_amount]', 'Reserve Amount') !!}
							{!! Form::number('addon[0][addons_reserve_amount]', null, ['class' => 'form-control']) !!}
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							{!! Form::label('addon[0][addons_image]', 'Add ons Image') !!}
				...
				<div class="row">
					<div class="col-md-12 text-right">
						<button type="button" name="addon[0][addons_add_hotel]" class="btn btn-success addon_more_hotel" value="Add hotel">Add More Hotel</button>
					</div>
				</div>
				<div class="addon_hotels">
					<div class="row">
				...
				<div class="row">
					<div class="col-md-12 text-right">
						<button type="button" name="addon[0][addons_add_airline]" class="btn btn-success add_addon_airline" value="Add airline">Add More Airline</button>
					</div>
				</div>
				<div class="addon_airlines">
					<div class="row">
