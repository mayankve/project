		...
		<div class="panel panel-success activities_details">
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-md-4">
						<div class="form-group">
							{!! Form::label('included_activity[0][activity_name]', 'Activity Name') !!}
							{!! Form::text('included_activity[0][activity_name]', null, ['class' => 'form-control']) !!}
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							{!! Form::label('included_activity[0][activity_detail]', 'Activity Detail') !!}
							{!! Form::text('included_activity[0][activity_detail]', null, ['class' => 'form-control']) !!}
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							{!! Form::label('included_activity[0][activity_cost]', 'Activity Cost') !!}
							{!! Form::number('included_activity[0][activity_cost]', null, ['class' => 'form-control']) !!}
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							{!! Form::label('included_activity[0][activity_our_cost]', 'Activity Our Cost') !!}
							{!! Form::number('included_activity[0][activity_our_cost]', null, ['class' => 'form-control']) !!}
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							{!! Form::label('included_activity[0][activity_due_date]', 'Due Date') !!}
							{!! Form::date('included_activity[0][activity_due_date]', null, ['class' => 'form-control']) !!}
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							{!! Form::label('included_activity[0][activity_reserve_type]', 'Reserve Type') !!}
							{!! Form::select('included_activity[0][activity_reserve_type]', array(0 => 'Flat', 1 => 'Percentage'), null, ['class' => 'form-control']) !!}
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							{!! Form::label('included_activity[0][activity_reserve_amount]', 'Reserve Amount') !!}
							{!! Form::number('included_activity[0][activity_reserve_amount]', null, ['class' => 'form-control']) !!}
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							{!! Form::label('included_activity[0][activity_image]', 'Activity Image') !!}
							{!! Form::file('included_activity[0][activity_image]', ['class' => 'form-control']) !!}
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12 text-right">
						<button type="button" name="included_activity[0][activity_add_hotel]" class="btn btn-success add_activities_hotel" value="Add activity">Add More Hotel</button>
					</div>
				</div>
				<div class="activities_hotels">
					<div class="row">
					...
					<div class="row">
						@include('admin.trip.partials.create-trip-hotels-fields', array('name' => 'included_activity[0][activity_hotels]', 'old' => false))
						<div class="col-md-12 remove-activity-hotels-div"></div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12 text-right">
						<button type="button" name="included_activity[0][activity_add_airline]" class="btn btn-success add_activities_airline" value="Add airline">Add More Airline</button>
					</div>
				</div>
				<div class="activities_airlines">
					<div class="row">
					...
					<div class="row">
						@include('admin.trip.partials.create-trip-airlines-fields', array('name' => 'included_activity[0][activity_airlines]', 'old' => false))
						<div class="col-md-12 remove-activity-airline-div"></div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12 remove-activities-details-div"></div>
				</div>
			</div>
		</div>
	@endif
