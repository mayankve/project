            ...
            <div class="cust-input-group included-activity-row pt-4 pb-2">     
                <fieldset class="trip_collection">
                	<fieldset>
                        ...
                        <fieldset class="addons_hotel_collection"><legend>Activity Airline</legend><fieldset><label class="mycss classes ">
                                ...
                                <label><span>Departure Location</span>
                                    <input type="text" name="" class="form-control&amp;#x20;" value=""></label><label><span>Departure Date</span><input type="date" name="included_activity&amp;#x5B;__index__&amp;#x5D;&amp;#x5B;activity_airlines&amp;#x5D;&amp;#x5B;0&amp;#x5D;&amp;#x5B;airline_departure_date&amp;#x5D;" class="form-control&amp;#x20;date" value=""></label><label><span>Departure Time</span><input type="time" name="" class="form-control-time" value=""></label><label><span>Layovers (MM)</span><input type="number" name="included_activity activity_airlines airline_layovers" class="form-control&amp;#x20;" value=""></label>
                                <label><span>Baggage Allowance (Kg)</span><input type="number" name="airline_baggage_allowance" class="form-control&amp;#x20;" step="0.01" value=""></label><label><span>Our Cost</span><input type="number" name="included_activity#x5B;activity_airlines&amp;#x5D;&amp;#x5B;0&amp;#x5D;&amp;#x5B;airline_our_cost&amp;#x5D;" class="form-control&amp;#x20;" value=""></label><label><span>Cost</span><input type="number" name="included_activity&amp;#x5B;__index__&amp;#x5D;&amp;#x5B;activity_airlines&amp;#x5D;&amp;#x5B;0&amp;#x5D;&amp;#x5B;airline_cost&amp;#x5D;" class="form-control&amp;#x20;" value=""></label><label><span>Due Date</span><input type="date" name="" class="form-control&amp;#x20;date" value=""></label><label class="mycss&amp;#x20;classes&amp;#x20;"><span>Reserve Type</span><select name="" class="form-control">
                                        <option value="0">Flat</option>
                                        <option value="1">Percentage</option></select></label><label><span>Reserve Amount</span><input type="number" name="" class="form-control&amp;#x20;" value=""></label></fieldset><span ></span>
                        </fieldset>
                    </fieldset>
                </fieldset>
                <!-- Remove detail container -->
		        ...
		        <div class="cust-input-group addons-row pt-4 pb-2"> 
		            <fieldset class="trip_collection">
		            	<fieldset>
		                    ...
		                    <fieldset class="addons_hotel_collection"><legend>Add ons Airline</legend><fieldset><label class="mycss classes "><span>Airline Name</span>
		                            ...
		                            <label><span>Reserve Amount</span>
		                                <input required="required" type="number" name="addon[][addons_airlines][][airline_reserve_amount]" class="form-control " value=""></label></fieldset>
		                    </fieldset>
		                </fieldset>
		            </fieldset>
		            <!-- Remove detail container -->
            ...
            <div class="col-md-12 hotel_details">
                <div class="cust-input-group hotel-row pt-4 pb-2">     
                    <fieldset class="trip_collection">
                    	...
                    	</fieldset><span data-template=''></span>
                    </fieldset>
                    <!-- Remove detail container -->
        ...
        <div class="todo-contaner row-box">  
            ...
            <div class="col-md-12 todo_details">
                <div class="cust-input-group todo-row pt-4 pb-2">     
                    <fieldset class="trip_collection">
                    	<fieldset><label><span>Do/Packing</span>
