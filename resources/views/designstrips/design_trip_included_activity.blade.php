                                        ...
                                        <div class="basic_info_view">   
                                            <div class="form-horizontal">
                                                ...
                                                <div class="addon-available-flights">
                                                    ...
                                                    ?> 
                                                    @if(!empty($includedActivityFlights))
                                                    @foreach( $includedActivityFlights AS $airlines)
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="row">
                                                                ...
                                                                <label>
																   ...
																   <input type="radio" name="included_activity_flight[{{$includedActivity->id}}]" value="{{$airlines->id}}" class="included_activity_flight">
                                                                </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="trip-addons">
                                                ...
                                                <div class="form-group pdrow-group">
                                                 <?php
                                                    ...
                                                    ?> 
                                                    @if(!empty($includedActivityHotles))
                                                    @foreach( $includedActivityHotles AS $hotels)
												<div class="form-group pdrow-group">
                                                        <div class="col-sm-12">
                                                            <div class="row">
															<div class="col-sm-1">
																...
																<div class="col-sm-1">
                                                                <label>
																<input type="radio" name="included_activity_hotel[{{$includedActivity->id}}]" value="{{$hotels->id}}" class="included_activity_hotel">
