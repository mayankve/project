                                                ...
                                                <div class="land-only_activity" style="display: none;">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <div class="row">
                                                                <div class="user-edit col-sm-6">
                                                                    <input type="text" name="activity_flight_departure_date[{{$includedActivity['tripIncludedActivities_check']->id}}]" id="flightdeparture" class="form-control departure_date" value="">
