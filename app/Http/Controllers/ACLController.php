...
class ACLController extends Controller
{
    ...
    public function addUser()
    {
             $user = new User();
             $user->name         = 'Niwedita';
             $user->email = 'niwedita@aat.com'; // optional
             $user->password  =  Hash::make('nivi@123');
             $user->save();
    }
     /* 
    ...
    public function addRole()
    {
             ...
             $user->description  = 'User associated with a company'; // optional
             $user->save();
    }
    ...
    {
        $user = User::where('email', '=', 'niwedita@aat.com')->first();
    ...
    {
        $user = User::where('email', '=', 'admin@aat.com')->first();
